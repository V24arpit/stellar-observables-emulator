...
# This code follows the same road map as michael neilson has mentioned in his book .
class Class_obser(object):
    ...
    # It uses ELU instead of sigmoid .
    # ELU is used in the dense network and in the output layer its just linear. 
    ...
    # this function is to save the model weights and biases.
    ...
    # and this is to load them for a fresh run .
